...
(
    id bigint NOT NULL nextval(client_id_seq::regclass),
...
(
    id bigint NOT NULL nextval(sales_id_seq::regclass),
    amount numeric(9,6),
    date date,
    client_id bigint,
...
(
    row_id bigint NOT NULL nextval(sales_detail_id_seq::regclass),
